...
export default class Game {
  ...
  takeTurn() {
    ...
    if (this.numberOfDice > 1){ //checks for user input of 2 dice
      this.dice2.roll()
      if (this.dice1.value <= 1){ // if you rolled a number equal to 1
        if (this.dice2.value <= 1){ //checks if the dice number rolled is greater than 2
          ...
          this.players[this.currentPlayer].turnScore = 0; //set score variable back to 0
